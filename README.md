...
A feature-rich image viewer and editor for Pulsar. View, edit, and transform images directly in your editor with support for cropping, rotation, flipping, blurring, and more.
...
- **Color Inversion**: Reverse colors for better visibility
...
- Selection operations (crop, blur)
- Save options
