  ...
  class ImageEditorView {
    constructor(editor) {
      ...
      this.disposables.add(atom.commands.add(this.element, {
        ...
        'image-editor:blur-light': () => this.blurImage(3),
        'image-editor:blur-medium': () => this.blurImage(6),
        'image-editor:blur-strong': () => this.blurImage(10),
    ...
    rotate(degrees) {
      ...
      // Save to history before rotating
      this.saveToHistory()
    ...
    flipHorizontal() {
      ...
      // Save to history before flipping
      this.saveToHistory()
    ...
    applyGrayscale() {
      ...
      const areaText = area.hasSelection ? 'selection' : 'image'
      this.updateImageFromCanvasWithoutHistory(canvas, `Grayscale applied to ${areaText}`)
    }
    ...
    // Helper method to update image from canvas without saving to history
    // (Use when history is already saved before calling this)
