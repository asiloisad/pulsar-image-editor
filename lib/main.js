...
// Files with these extensions will be opened as images by default
const imageExtensions = [".bmp", ".gif", ".ico", ".jpeg", ".jpg", ".png", ".webp"];

// Files with these extensions can be opened in image-editor via command/context menu,
// but will NOT be intercepted by the default opener (e.g. SVG files)
const optionalImageExtensions = [".svg"];
