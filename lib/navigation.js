...
class ImageNavigator {
  ...
  preloadImage(imagePath, containerWidth, containerHeight, currentZoom, autoMode) {
    ...
    try {
      ...
      img.onload = () => {
        ...
        if (autoMode) {
          // Zoom to fit mode with 100% limit (matches view.js zoomToFit behavior)
  ...
  async preloadAdjacentImages(currentPath, containerWidth, containerHeight, currentZoom, autoMode) {
