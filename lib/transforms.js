...
function rotateImage(sourceCanvas, degrees, canvasPool = null) {
  ...
  const canvas = canvasPool ? canvasPool.getCanvas(width, height) : document.createElement("canvas");
  canvas.width = width;
...
function freeRotateImage(sourceCanvas, degrees, expandCanvas = true, canvasPool = null) {
  ...
  // Get canvas from pool or create new one
  const canvas = canvasPool ? canvasPool.getCanvas(canvasWidth, canvasHeight) : document.createElement("canvas");
...
function resizeImage(sourceCanvas, newWidth, newHeight, canvasPool = null) {
  const canvas = canvasPool ? canvasPool.getCanvas(newWidth, newHeight) : document.createElement("canvas");
