...
module.exports =
  class ImageEditorView {
    constructor(editor) {
      ...
      this.disposables.add(atom.tooltips.add(this.refs.zoomTo100Button, { title: 'Scale image to fit, but nor more than 100%', keyBindingCommand: 'image-editor:zoom-to-100' }))
