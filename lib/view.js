  ...
  class ImageEditorView {
    ...
    blurImage(blurLevel) {
      ...
      setTimeout(() => {
        ...
        this.updateImageFromCanvasWithoutHistory(canvas, `Blur level ${blurLevel} applied to ${areaText}`, 'blur')
      }, 10)
    }
    ...
    applyGrayscale() {
      ...
      const areaText = area.hasSelection ? 'selection' : 'image'
      this.updateImageFromCanvasWithoutHistory(canvas, `Grayscale applied to ${areaText}`, 'adjustment')
    }
    ...
    applyBrightnessContrast(brightness, contrast) {
      ...
      const areaText = area.hasSelection ? 'selection' : 'image'
      this.updateImageFromCanvasWithoutHistory(canvas, `Brightness & contrast adjusted on ${areaText}`, 'adjustment')
    }
    ...
    applySaturation(saturation) {
      ...
      const areaText = area.hasSelection ? 'selection' : 'image'
      this.updateImageFromCanvasWithoutHistory(canvas, `Saturation adjusted on ${areaText}`, 'adjustment')
    }
    ...
    autoAdjustColors() {
      ...
      const areaText = area.hasSelection ? 'selection' : 'image'
      this.updateImageFromCanvasWithoutHistory(canvas, `Auto adjusted colors on ${areaText}`, 'adjustment')
    }
    ...
    applyHueShift(hueShift) {
      ...
      const areaText = area.hasSelection ? 'selection' : 'image'
      this.updateImageFromCanvasWithoutHistory(canvas, `Hue shifted on ${areaText}`, 'adjustment')
    }
    ...
    applyPosterize(levels) {
      ...
      const areaText = area.hasSelection ? 'selection' : 'image'
      this.updateImageFromCanvasWithoutHistory(canvas, `Posterized to ${levels} levels on ${areaText}`, 'adjustment')
    }
